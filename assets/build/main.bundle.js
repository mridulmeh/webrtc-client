...
//Siganling client
var symplClient = void 0;
var remotePeer = void 0;
//The current peerconnection
var currentPeerConnection = void 0;
...
$(document).ready(function () {
	...
	$(".player1 #ConnectBtn").click(function () {
	...
	$(".player2 #ConnectBtn").click(function () {
		$("#StreamPlayer").css("display", "block");
...
function initSymple() {
	...
	$.post(window.location.href.substr(0, window.location.href.indexOf(":", 10)) + ':' + '4500' + "/setJoystick", { 'config': clientConfig.peer }, function (res) {
		// if(virtualJs!=res){
		// virtualJs=res;
...
function recvRemoteSDP(desc) {
	...
	currentPeerConnection.setRemoteDescription(new RTCSessionDescription(desc), function () {
...
*/
function sendAnswer() {
	currentPeerConnection.createAnswer(function (desc) {
		// success
